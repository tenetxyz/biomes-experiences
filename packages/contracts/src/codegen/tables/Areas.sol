...
library Areas {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "bountyhunter", name: "Areas", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x7462626f756e747968756e746572000041726561730000000000000000000000);
