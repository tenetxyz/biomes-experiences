...
library Areas {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "racetothesky", name: "Areas", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x746272616365746f746865736b79000041726561730000000000000000000000);
