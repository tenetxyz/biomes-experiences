...
library Countdown {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "deathmatch", name: "Countdown", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x746264656174686d6174636800000000436f756e74646f776e00000000000000);
