...
library ExperienceMetadata {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "deathmatch", name: "ExperienceMetada", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x746264656174686d6174636800000000457870657269656e63654d6574616461);
