...
library ExperienceMetadata {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "bountyhunter", name: "ExperienceMetada", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x7462626f756e747968756e7465720000457870657269656e63654d6574616461);
