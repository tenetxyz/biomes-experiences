...
library DisplayRegisterMsg {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "buildanomics", name: "DisplayRegisterM", typeId: RESOURCE_OFFCHAIN_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x6f746275696c64616e6f6d6963730000446973706c617952656769737465724d);
