...
library DisplayRegisterMsg {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "bountyhunter", name: "DisplayRegisterM", typeId: RESOURCE_OFFCHAIN_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x6f74626f756e747968756e7465720000446973706c617952656769737465724d);
