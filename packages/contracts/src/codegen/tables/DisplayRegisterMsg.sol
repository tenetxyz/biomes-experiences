...
library DisplayRegisterMsg {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "racetothesky", name: "DisplayRegisterM", typeId: RESOURCE_OFFCHAIN_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x6f7472616365746f746865736b790000446973706c617952656769737465724d);
