...
library Players {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "deathmatch", name: "Players", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x746264656174686d6174636800000000506c6179657273000000000000000000);
