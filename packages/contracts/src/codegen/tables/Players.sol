...
library Players {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "racetothesky", name: "Players", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x746272616365746f746865736b790000506c6179657273000000000000000000);
   ...
   * @notice Get players.
   */
  function get() internal view returns (address[] memory players) {
    bytes32[] memory _keyTuple = new bytes32[](0);
   ...
   * @notice Get players.
   */
  function _get() internal view returns (address[] memory players) {
    bytes32[] memory _keyTuple = new bytes32[](0);
   ...
   * @notice Set players.
   */
  function set(address[] memory players) internal {
    bytes32[] memory _keyTuple = new bytes32[](0);
   ...
   * @notice Set players.
   */
  function _set(address[] memory players) internal {
    bytes32[] memory _keyTuple = new bytes32[](0);
