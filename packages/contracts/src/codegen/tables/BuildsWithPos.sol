...
library BuildsWithPos {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "deathmatch", name: "BuildsWithPos", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x746264656174686d61746368000000004275696c647357697468506f73000000);
