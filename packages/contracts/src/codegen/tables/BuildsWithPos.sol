...
library BuildsWithPos {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "buildanomics", name: "BuildsWithPos", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74626275696c64616e6f6d69637300004275696c647357697468506f73000000);
