...
library DisplayUnregisterMsg {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "deathmatch", name: "DisplayUnregiste", typeId: RESOURCE_OFFCHAIN_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x6f7464656174686d6174636800000000446973706c6179556e72656769737465);
