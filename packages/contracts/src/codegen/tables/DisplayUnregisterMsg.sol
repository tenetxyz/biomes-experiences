...
library DisplayUnregisterMsg {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "bountyhunter", name: "DisplayUnregiste", typeId: RESOURCE_OFFCHAIN_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x6f74626f756e747968756e7465720000446973706c6179556e72656769737465);
